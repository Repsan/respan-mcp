...
export function registerPromptTools(server: McpServer) {
  ...
  server.tool(
    "list_prompts",
    "Get all Prompts list with pagination support",
    {
  ...
  server.tool(
    "get_prompt_detail",
    "Get detailed information of a specified Prompt",
    {
  ...
  server.tool(
    ...
    "Get all version list of a specified Prompt",
    {
      prompt_id: z.string().describe("Unique identifier ID of the Prompt")
    },
    async ({ prompt_id }, extra) => {
  ...
  server.tool(
    ...
    "Get detailed information of a specific version of a specified Prompt",
    {
      prompt_id: z.string().describe("Unique identifier ID of the Prompt"),
