...
export function registerTraceTools(server) {
    // --- List Traces ---
    server.tool("list_traces", "Get Traces list with filtering and sorting support", {
    ...
    // --- Get Trace Tree ---
    server.tool("get_trace_tree", "Get the complete tree structure of a single Trace", {
