...
export function registerUserTools(server) {
    // --- List Customers ---
    server.tool("list_customers", "Get customer list with sorting by cost, number of requests, etc.", {
    ...
    // --- Get Customer Detail ---
    server.tool("get_customer_budget_detail", "Get customer's detailed information and budget usage", {
