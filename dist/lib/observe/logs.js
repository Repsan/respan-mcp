...
export function registerLogTools(server) {
    // --- List Logs ---
    server.tool("list_logs", "Get request log list with complex filtering and sorting support", {
    ...
    // --- Get Single Log ---
    server.tool("get_log_detail", "Get detailed information of a single log", {
